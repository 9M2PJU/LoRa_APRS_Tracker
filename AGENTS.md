...
| `data_embed/index.html` | Page title "9M2PJU Mod", navbar brand, footer 9M2PJU credit, email field label (posmsg), Winlink section (callsign@winlink.org example), Malaysian e-wallet QR code in footer | Web UI layout, new form fields |
